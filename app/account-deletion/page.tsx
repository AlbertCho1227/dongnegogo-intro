  ...
  return (
    <LegalPage eyebrow="이용자 권리" title="계정·데이터 삭제" description="로그인 계정과 연결 데이터를 삭제하거나, 계정을 유지한 채 특정 데이터만 삭제할 수 있습니다.">
      ...
      <LegalSection title="5. 처리 제한과 문의">
        <p>분쟁 처리, 수사 협조 등 법령상 보존 의무가 있는 정보는 다른 정보와 분리하고 법정 기간이 끝나면 삭제합니다. 삭제 완료 후에는 복구할 수 없습니다. 문의는 <a href="mailto:forestieum@gmail.com">forestieum@gmail.com</a>으로 보내주세요.</p>
      </LegalSection>
    </LegalPage>
  );
}
