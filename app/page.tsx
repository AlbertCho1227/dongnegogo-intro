...
const HERO_TITLE_RESPONSIVE = '    <h1 data-r="hero-title" style="margin:0;font-size:54px;font-weight:900;line-height:1.28;letter-spacing:-0.02em;color:#20241F"><span data-r="responsive-line">우리 주변의 배움&nbsp;<span data-r="hero-particle" style="display:inline-block;font-size:60%;line-height:1;vertical-align:baseline">과</span>&nbsp;</span><br data-r="mobile-break"><span data-r="responsive-line">즐거움을 한눈에</span><br><span data-r="responsive-line" style="background: linear-gradient(135deg, rgb(107, 190, 46) 0%, rgb(47, 180, 87) 100%) text; color: transparent;">동네고고 하나로</span></h1>';
