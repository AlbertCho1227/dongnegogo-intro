    ...
    <LegalPage eyebrow="개인정보 보호" title="개인정보처리방침" description="동네고고는 필요한 정보만 처리하고, 계정과 위치 정보의 흐름을 숨김없이 설명합니다.">
      ...
      <LegalSection title="3. 처리하는 개인정보">
        <DataTable headers={["구분", "항목", "목적", "보유기간"]} rows={[
          ...
          ["로컬 기기", "기기 내 임의 식별자, 최근 검색·열람, 캐시, 화면 설정", "비로그인 이용과 성능 개선", "앱 삭제·기기 설정 초기화 또는 계정 삭제 완료 시 즉시 삭제"],
      ...
      <LegalSection title="6. 파기와 보호조치">
        <p>앱에서 본인 확인과 최종 문구 입력을 마치면 사진 저장소, 운영 DB의 후기·댓글·찜·알림·가족·동의 기록, Supabase Auth 사용자·연결·세션을 순서대로 즉시 삭제합니다. iOS·Android·앱인토스의 계정 관련 로컬 저장값과 캐시도 함께 삭제하며 30일 복구·유예 기간을 운영하지 않습니다.</p>
